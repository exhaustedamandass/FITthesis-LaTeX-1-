...
This design cleanly separates symbol lookup, context checking, and AST traversal, producing a comprehensive list of mutation candidates that downstream code can transform and validate \cite{rcore2024}.
