...
\begin{itemize}
  ...
  \item \textbf{Adoption and Support:} Comply with CRAN policies and support major R versions (≥3.6) to maximize user adoption and community contributions \cite{rcore2024}.
\end{itemize}
